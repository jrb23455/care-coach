export const audioConversations = [
  {
    id: 'rate-increase',
    title: 'Rate Increase Shock',
    description: 'Customer blindsided by a 30% premium jump at renewal.',
    turns: [
  ...
  {
    id: 'claim-denied',
    title: 'Claim Denied — Loyal Customer',
    description: 'A 10-year customer is devastated after their claim is denied.',
    turns: [
  ...
  },
  {
    ...
    title: 'Supervisor Demand',
    description: "Frustrated customer demands a manager after three weeks of unresolved billing.",
    turns: [
  ...
  {
    id: 'crisis-call',
    title: 'Total Loss — Customer in Crisis',
    description: 'A distressed customer calls right after their car is totaled.',
    turns: [
